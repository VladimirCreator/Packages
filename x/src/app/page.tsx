...
const shit = {
	...
	{ super: 5, id: 14, title: 'Человек 1', proportion: 50, children: [] }, { super: 5, id: 15, title: 'Человек 2', proportion: 30, children: [] }, { super: 5, id: 16, title: 'Человек 3', proportion: 10, children: [] }, { super: 5, id: 17, title: 'Человек 4', proportion: 10, children: [] }, { super: 6, id: 18, title: 'Человек 5', proportion: 50, children: [] }, { super: 6, id: 19, title: 'Человек 6', proportion: 50, children: [] },

	{ super: 7, id: 20, title: 'Человек 7', proportion: 50, children: [] }, { super: 7, id: 21, title: 'Человек 8', proportion: 50, children: [] },

	{ super: 8, id: 22, title: 'Человек 9', proportion: 50, children: [] }, { super: 8, id: 23, title: 'Человек 10', proportion: 50, children: [] },

	{super:9,id:24,title:'Человек 11',proportion:1,children:[]},{super:9,id:25,title:'Человек 12',proportion:2,children:[]},{super:9,id:26,title:'Человек 13',proportion:3,children:[]},{super:9,id:27,title:'Человек 14',proportion:4,children:[]},{super:9,id:28,title:'Человек 15',proportion:5,children:[]},{super:9,id:29,title:'Человек 16',proportion:85,children:[]},

	{ super: 10, id: 30, title: 'Человек 17', proportion: 33, children: [] }, { super: 10, id: 31, title: 'Человек 18', proportion: 33, children: [] }, { super: 10, id: 32, title: 'Человек 19', proportion: 33, children: [] },

	{super:11,id:33,title:'Угол 1',proportion:33,children:[]},{super:11,id:34,title:'Угол 2',proportion:33,children:[]},{super:11,id:35,title:'Угол 3',proportion:33,children:[]},
	{super:12,id:36,title:'Угол 1',proportion:25,children:[]},{super:12,id:37,title:'Угол 2',proportion:25,children:[]},{super:12,id:38,title:'Угол 3',proportion:25,children:[]},{super:12,id:39,title:'Угол 4',proportion:25,children:[]},
...
export default function() {
	...
	useAPI('https://api.github.com/repos/vladimircreator/playgrounds/commits', (response) => dispatch(shit))

	const handleClick = (id: number) => setId(id)

	if (typeof application.state.includes('undefined')) { return (<Loading />) }
	else if (application.state.includes('loaded')) {
		return (
				<AllContext.Provider value={application.data}
					children={
						<List identifier={id} onClick={handleClick} />
					}
				/>
		)
	}
