import { isEmpty, isDigit, isLatin, isRangeUnderflow, isRangeOverflow, includesDigit, includesLatin, includesRegExp, isAdult } from './checkers.js'
...
export const rulesForFirstName = [
  ...
  {
    rule: (firstName) => firstName.includes(' '),
...
export const rulesForLastName = [
  ...
  {
      rule: (lastName) => lastName.includes(' '),
...
export const rulesForBirthday = [
  {
      rule: (userDate) => !isAdult(userDate),
