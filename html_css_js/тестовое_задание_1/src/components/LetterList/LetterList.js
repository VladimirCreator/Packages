...
const using = {
    date_ascending: (a, b) => new Date(a.published).getTime() - new Date(b.published).getTime(),
    date_descending: (a, b) => new Date(b.published).getTime() - new Date(a.published).getTime()
};
